/*
c++ -o fabry fabry.cpp `root-config --cflags --glibs`
*/
...
int main(int argc, char** argv)
{
  ...
  myGraph->SetTitle("Calibrazione micrometro: #Deltad' vs. #DeltaN");
  myGraph->GetXaxis()->SetTitle("#Delta N");
  myGraph->GetYaxis()->SetTitle("#Delta d' [#mum]");
  
  TF1* myFun = new TF1 ("myFun","[0]+[1]*x");
  myFun->SetParName(0,"A");
  myFun->SetParName(1,"B");
  myFun->SetParameter(0,-4);
